...
When we write $W\subset Z$, we mean that $W$ is simultaneously a sub-graph of $Z$, in addition to being a multivariate random variable consisting of all individual random variables $z^i, \quad i \in W$. 
